...
struct fmtdesc {
	...
	const char * name, * longname, * suffix;
 ...
 */
static const char * endname P1((name), const char * name)
{
	if (name) {
 ...
 */
static void parse_argv0 P1((av0), const char * av0)
{
	int 	l;
	const char * temp;
	if (av0) temp = av0;
	else temp = "toast";
	progname = av0 = endname(temp);
 ...
 */
static char * suffix P2((name, suf), char *name, const char * suf)
{
...
static char* normalname P3((name, want, cut), char *name, const char *want, const char *cut)
{
	size_t	maxlen;
	char 	* s, * p;
