 ...
 *
 */
const char *say_id = "$Id: say.c,v 1.13 1994/11/08 13:30:50 a904209 Exp a904209 $";
...
static unsigned xlate_word PROTO((const char *word, int n, darray_ptr phone));
